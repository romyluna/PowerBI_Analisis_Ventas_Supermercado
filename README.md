...
El dashboard permite responder preguntas de negocio clave a partir del análisis de datos históricos de ventas.
...
- Evaluar el desempeño por **región** y **sucursal**
- Detectar tendencias positivas y negativas en ventas
- Apoyar la toma de decisiones comerciales mediante visualizaciones claras
...
- El producto **Botella de agua mineral** presenta un comportamiento estacional con mayores ventas entre **noviembre y enero**, y una disminución entre **junio y septiembre**.
- La **Lata de maíz en conserva** muestra una **tendencia descendente** en el período analizado.
...
Proyecto orientado a roles de **Analista BI / Analista de Planeamiento / Analista de Datos**.
